...
const checkRequiredFields=(inputArr)=>{
    inputArr.forEach((input)=>{
        if(input.value.trim()===""){  //trim for whitespace
...
form.addEventListener('submit',(e)=>{
    e.preventDefault();//for flashing page removal
...
//to turn off autocomplete to all attributes for predefined input that pops up
